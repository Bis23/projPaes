...
const ConsultaAtv = () => {
    ...
    const atividades = axios.get(`http://localhost:4000/atividade/consulta/`, {params: {rg: rg}})
                ...
                <Container>
                    <Row className='justify-content-center'>
                        <div className='bg-white rounded mt-4 pt-3 mb-1 col-10'>
                            <h3 className='justify-content-center d-flex mb-4 font-weight-bold'>Aqui estão seus projetos e atividades cadastrados.</h3>
                            <div className='py-3'>
                                {state?.map((data, key) => {
                                    return (
